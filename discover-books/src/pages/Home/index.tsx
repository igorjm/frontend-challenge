...
import CardVideoReview from '../../components/CardVideoReview';
...
const Home = () => {
    ...
    const getCardBook = async () => {
        const res : any = [
            ...
            {
                data: (await api.get('/volumes/ROoCnwEACAAJ')).data,
                color: '#451475'
            },
            {
                data: (await api.get('/volumes/kytJt5xcUmQC')).data,
                color: '#3F4043'
            }
        ];
        const response: ICardBooks = await api.get(`/volumes/eLRhDgAAQBAJ`);
    ...
    const getBooks = async () => {
        ...
        if (search) {
            const res: any = await api.get(`/volumes?q=${search}&maxResults=40`);
            if (res) {
                            ...
                            isSearching ? (
                                ...
                                <>
                                    ...
                                    <section className='videosContainer'>
                                        <CardVideoReview
                                            thumb={'https://i.ytimg.com/vi/vBzBgewl4ac/hq720.jpg?sqp=-oaymwEcCOgCEMoBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLB4QuHiW8ShUUSPpZTgTvRSzF9U2g'}
